...
export GH_ORG=${GH_ORG:-avarteqgmbh}
export GH_REPO=${GH_REPO:-banery_stats_go}
export NAME=${NAME:-"Kanbanery CLI stats"}
...
if [[ "$GITHUB_TOKEN" == "" ]]; then
    echo "You need to set up your GITHUB_TOKEN as an environment variable before you can continue."
    exit 1
fi
